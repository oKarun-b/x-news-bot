...
TITLE_SUFFIXES = [
    ...
    r"\s*[-–—|]\s*Washington Examiner\s*$",
    r"\s*[-–—|]\s*Washington Post\s*$",
    r"\s*[-–—|]\s*Al Jazeera\s*$",
    r"\s*[-–—|]\s*Anadolu Ajans[ıi]\s*$",
    r"\s*[-–—|]\s*Anadolu Agency\s*$",
    ...
    r"\s*[-–—|]\s*Sky News\s*$",
    r"\s*[-–—|]\s*The Times\s*$",
    r"\s*[-–—|]\s*Jerusalem Post\s*$",
    r"\s*[-–—|]\s*The Times of Israel\s*$",
    r"\s*[-–—|]\s*Kyiv (?:Post|Independent)\s*$",
    r"\s*[-–—|]\s*RBC-Ukraine\s*$",
    r"\s*[-–—|]\s*Hill\s*$",
    r"\s*[-–—|]\s*The Hill\s*$",
    r"\s*[-–—|]\s*[A-Z][a-zA-Z0-9 &.'-]{2,40}\.(?:com|net|org|co\.uk|co)\s*$",  # generic "- something.com" tails
    r"\s*[-–—|]\s*(?:The\s+)?[A-Z][a-zA-Z]{1,20}\s+Tribune\s*$",  # "- X Tribune"
    r"\s*[-–—|]\s*The\s+Jerusalem\s+Post\s*$",
    r"\s*[-–—|]\s*Jerusalem\s+Post\s*$",
]
